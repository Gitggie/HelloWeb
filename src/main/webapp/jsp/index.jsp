...
<head>
    ...
    <title>无标题文档</title>
    <%--网页框架，加上${pageContext.request.contextPath}这个图片只剩1张--%>
    ...
    <div class="container">
        ...
        <div id="open-nav" class="navbar-collapse collapse" aria-expanded="false" style="height: 1px;">
            <ul class="nav navbar-nav navbar-right text-center list-inline">
                <li><a href="">首页</a></li>
                <li><a href="${pageContext.request.contextPath}/t11">职业</a></li>
                <li><a href="">推荐</a></li>
                <li><a href="">关于</a></li>
            </ul>
        </div>
...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img alt="First slide" src="${pageContext.request.contextPath}/my/annihaisewei.png">
        </div>
        <div class="item">
            <img alt="Second slide" src="${pageContext.request.contextPath}/my/06c2f77703f1391e59c1590672ef07c7.png">
        </div>
        <div class="item">
            <img alt="Third slide" src="${pageContext.request.contextPath}/my/annihaisewei.png">
        </div>
        <div class="item">
            <img alt="Third slide" src="${pageContext.request.contextPath}/my/06c2f77703f1391e59c1590672ef07c7.png">
        </div>
...
<div class="main container">
    ...
    <div class="main-a row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 text-center">
            <p>
                <img src="${pageContext.request.contextPath}/t10/imges/453254312.png">${learnings}<br>
                <span class="up-3">累计在线学习人数</span>
            </p>
            <p>
                <img src="${pageContext.request.contextPath}/t10/imges/453254312.png">${workings}<br>
    ...
    <div class="main-c row">
        ...
        <ul class="list-unstyled text-center">
            <c:forEach items="${students}" var="students" begin="0" end="6">
            <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div>
                    <img src="${pageContext.request.contextPath}/my/eyes.jpg">
                    <span>${students.name}</span>
                    <p class="text-left">${students.major}:${students.detail}</p>
                </div>
            </li>
            </c:forEach>
        </ul>
